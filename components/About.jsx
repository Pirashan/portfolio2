    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                progressing through a foundational C# course provided by Microsoft. I am excited to 
                announce that I will be attending Georgia Institute of Technology starting September 2024 
                for a MS in Computer Science!
                </p>
            </div>
